...
extension CoursesVC : UICollectionViewDelegate {
    ...
    func setupCoursesCollectionView() {
        ...
        self.coursesViewModel.Courses.bind(to: self.CoursesCollectionView.rx.items(cellIdentifier: cellIdentifier, cellType: AllCourseCell.self)) { index, element, cell in
